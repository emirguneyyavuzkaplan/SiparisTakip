        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiparisMasterId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Elektronik", new DateTime(2022, 5, 31, 13, 13, 39, 477, DateTimeKind.Local).AddTicks(5231), "001", "Elektronik" },
                    { 2, "Bilsayar", new DateTime(2022, 5, 31, 13, 13, 39, 477, DateTimeKind.Local).AddTicks(5244), "002", "Bilsayar" },
                    { 3, "Ceptelefonu", new DateTime(2022, 5, 31, 13, 13, 39, 477, DateTimeKind.Local).AddTicks(5244), "003", "CepTelefonu" },
                    { 4, "Beyaz Eyşa", new DateTime(2022, 5, 31, 13, 13, 39, 477, DateTimeKind.Local).AddTicks(5247), "004", "Beyaz Eyşa" }
                });
